...
class SImages {
  ...
  ///---App logo----just add color on ,where to use
    static const String darkApplogo="assets/logo/applogo.png";
    static const String lightApplogo="assets/logo/applogo.png";
  ///---Social logos
    static const google="assets/logos/google-icon.png";
    static const facebook="assets/logos/facebook-icon.png";

   ///---OnBoarding Images
    static const String onBoardingImage1="assets/images/on_boarding_images/shayon-line-delivery.gif";
    static const String onBoardingImage2="assets/images/on_boarding_images/shayon-line-searching.gif";
    static const String onBoardingImage3="assets/images/on_boarding_images/shayon-line-shopping.gif";
