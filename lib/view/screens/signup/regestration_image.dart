                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Padding(
                                    ...
                                    child: rp.imageBannerName != null
                                        ? Text('$rp.imageBannerName')
                                        : Text(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        ...
                                        child: Container(
                                          ...
                                          child: TextFormField(
                                            onChanged: (value) {
                                              rp.validaterepassword(value);
                                            },
                                            obscureText: _isObscured,
                                            controller: rp.rePasswordController,
                                            decoration: InputDecoration(
                                              suffixIcon: IconButton(
                                                onPressed: () {
                                                  setState(() {
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                      // onPressed: () {
                                      //   if (rp.passwordController.text.isNotEmpty &&
                                      //       rp.rePasswordController
                                      //           .text.isNotEmpty &&
                                      //       rp.ischeckd != false &&
                                      //       rp.imageBanner != null &&
                                      //       rp.imageFile != null) {
                                      //     setState(() {
                                      //     rp.ispasserror=false;
                                      //     rp.isrepasserror=false;
                                      //     });
                                      //
                                      //     Navigator.push(
                                      //         context,
                                      ...
                                      //   }
                                      //   else{
                                      //     if(rp.passwordController.text.isEmpty){
                                      //       setState(() {
                                      //         ispasserror=true;
                                      ...
                                      //   }
                                      // },
                                    onPressed: (){rp.imageValidate(context);},
                                      style: ElevatedButton.styleFrom(
                                          padding: EdgeInsets.symmetric(
                                              vertical: SDeviceUtlis.getScreenWidth(context)*.015, horizontal: SDeviceUtlis.getScreenHeight(context)*.070),
                                          shape: RoundedRectangleBorder(
